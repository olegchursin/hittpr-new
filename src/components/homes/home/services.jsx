  ...
  },
  {
    ...
    text_3: (
      <>
        ...
        <br></br>- Составляем план написания статьи Работаем материалом{' '}
        <br></br>- Собираем “пазл” Подбираем крутой заголовок <br></br>- Бонус:
        темы для вашего направления (для СМИ и соц.сетей).
      </>
    ),
    subtitle:
