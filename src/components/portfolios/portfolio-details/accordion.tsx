...
const Accordion = ({ items, title }) => {
  const accordion_title = title ? title : 'Frequently Asked Questions';
  const accordion_items = items ? items : accordion_items_default;
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-7">
              <h3 className="tp-title-sm mb-90">{accordion_title}</h3>
            </div>
          </div>
          <div className="row">
              ...
              <div className="tp-custom-accordio">
                <div className="accordion" id="accordionExample">
                  {accordion_items.map((item, i) => {
                    const { id, show, title, desc, url } = item;
                    return (
                      <div
                        key={id}
